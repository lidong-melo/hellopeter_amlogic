 ...
 * @param[in]  p_fifo   Pointer to the FIFO.
 *
 * @retval     SUCCESS              If the FIFO was flushed successfully.
 */
...
// /**@brief Function for reading bytes from the FIFO.
 ...
 // *
 // * @retval     SUCCESS          If the procedure is successful. The actual number of bytes read might
 ...
 // *                                  be NULL.
 // * @retval     ERROR_NOT_FOUND  If the FIFO is empty.
 // */
...
// /**@brief Function for writing bytes to the FIFO.
 ...
 // *
 // * @retval     SUCCESS       If the procedure is successful. The actual number of bytes written might
